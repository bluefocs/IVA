...
//
// Changed  c6713_dsk_init()   so it returns the codec handle DSK6713_AIC23_CodecHandle 
...
DSK6713_AIC23_CodecHandle c6713_dsk_init()       			//dsp-peripheral initialization
{
...
DSK6713_AIC23_CodecHandle comm_intr()						 	//for communication/init using interrupt
{
	DSK6713_AIC23_CodecHandle handle;
	
	poll=0;                        	//0 since not polling
   IRQ_globalDisable();           	//disable interrupts
	handle = c6713_dsk_init(); 					//init DSP and codec
